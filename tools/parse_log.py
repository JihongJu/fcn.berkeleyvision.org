...
def parse_log(path_to_log):
    ...
    regex_loss = re.compile('Iteration (\d+), (\S+) = ([\.\deE+-]+)')
    ...
    with open(path_to_log, 'r') as f:
        for line in f:
            ...
            loss_dict_list, loss_row = parse_line_for_net_output(
                regex_loss, loss_row, loss_dict_list,
    ...
    fix_initial_nan_learning_rate(loss_dict_list)
    fix_initial_nan_learning_rate(train_dict_list)
    fix_initial_nan_learning_rate(test_dict_list)

    return train_dict_list, test_dict_list, loss_dict_list
...
def save_csv_files(logfile_path, output_dir, train_dict_list, test_dict_list,
                   loss_dict_list, delimiter=',', verbose=False):
    ...
    loss_filename = os.path.join(output_dir, log_basename + '.loss')
    write_csv(loss_filename, loss_dict_list, delimiter, verbose)
...
def main():
    args = parse_args()
    train_dict_list, test_dict_list, loss_dict_list = parse_log(args.logfile_path)
    save_csv_files(args.logfile_path, args.output_dir, train_dict_list,
                   test_dict_list, loss_dict_list, delimiter=args.delimiter)
